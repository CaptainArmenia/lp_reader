                ...
                for box, track_id in zip(boxes, track_ids):
                    ...
                    if track_id not in license_plates:
                        ...
                        if len(track) > 15:
                            ...
                            if average_distance < 3 and stop_counter[track_id] < 30 and w * h > 3000:
                    ...
                    # If track has an associated license plate, draw it on the frame beneath the bounding box
                        ...
                        cv2.putText(vis_frame, "{:.2f}".format(lp_conf), (int(x - w / 2), int(y + h / 2 + 60)), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)
